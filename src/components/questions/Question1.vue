<template>
  <div class="question">
    <p>{{ questionFirstType.number }}&nbsp;&nbsp;{{ questionFirstType.text }}</p>
    <p>
...
<script>
  export default {
    ...
    methods: {
      isCorrect () {
        return (this.userAnswer.toLowerCase() === this.questionFirstType.answer.toLowerCase())
      },
      setShowAnswer (show) {
        this.showAnswer = show
      },
      getShowAnswer () {
        this.userAnswer = this.questionFirstType.answer
      },
      reset () {
